...
public class Saver extends Thread {
	...
	this.first=first; 
     ...
     try{
      ...
      File zipf= new File("destination/"+user.getNom()+"/"+dst.getName()+"/"+dst.getName()+".zip"); 
     ...
     first=false; 
      ...
      while (true) {
        ...
        try {
            sleep((long) ( this.frequence* 60000)); // le temps durant lequel le serveur ne fait rien en fonction de la fréquence
